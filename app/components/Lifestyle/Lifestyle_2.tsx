              ...
              export default function Lifestyle_2() {
                return (
                  <>
                    <div className="w-[300px] bg-box-bg bg-opacity-80 rounded-md overflow-hidden">
                      <div className="relative">
                        <img src="https://codehelp-apis.vercel.app/get-top-courses/Lifestyle/Fitness%20For%20Life.png" alt="Fitness for Life" />
                      ...
                      <div className="p-4">
                        <p className="text-white font-semibolt text-lg leading-6">Fitness for Life</p>
                        <p className="mt-2 text-white">This course covers the fundamentals of fitness, including exercise principles, workout planning, and nutrition. Students will learn how to build strength, endurance, and flexibility, and how to create a healthy and sustainable lifestyle.</p>
                      </div>
                    </div>
                  </>
                );
