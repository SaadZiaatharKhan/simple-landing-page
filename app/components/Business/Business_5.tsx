              ...
              export default function Business_5() {
                return (
                  <>
                    <div className="w-[300px] bg-box-bg bg-opacity-80 rounded-md overflow-hidden">
                      <div className="relative">
                        <img src="https://codehelp-apis.vercel.app/get-top-courses/Business/Project%20Management%20Essentials.png" alt="Project Management Essentials" />
                      ...
                      <div className="p-4">
                        <p className="text-white font-semibolt text-lg leading-6">Project Management Essentials</p>
                        <p className="mt-2 text-white">This course provides an overview of project management principles and techniques, including project planning, scheduling, budgeting, risk management, and stakeholder communication. Students will learn how to manage projects effectively, using both traditional and agile project management approaches.</p>
                      </div>
                    </div>
                  </>
                );
