              ...
              export default function Lifestyle_1() {
                return (
                  <>
                    <div className="w-[300px] bg-box-bg bg-opacity-80 rounded-md overflow-hidden">
                      <div className="relative">
                        <img src="https://codehelp-apis.vercel.app/get-top-courses/Lifestyle/Cooking%20Basics.png" alt="Cooking Basics" />
                      ...
                      <div className="p-4">
                        <p className="text-white font-semibolt text-lg leading-6">Cooking Basics</p>
                        <p className="mt-2 text-white">This course provides an introduction to cooking techniques, ingredients, and flavors. Students will learn how to plan and prepare meals, using simple recipes and kitchen tools. The course covers a range of cuisines and dietary preferences.</p>
                      </div>
                    </div>
                  </>
                );
