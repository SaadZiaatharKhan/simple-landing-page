              ...
              export default function Development_1() {
                return (
                  <>
                    <div className="w-[300px] bg-box-bg bg-opacity-80 rounded-md overflow-hidden">
                      <div className="relative">
                        <img src="https://codehelp-apis.vercel.app/get-top-courses/Development/Web%20Development%20Fundamentals.png" alt="Web Development Fundamentals" />
                      ...
                      <div className="p-4">
                        <p className="text-white font-semibolt text-lg leading-6">Web Development Fundamentals</p>
                        <p className="mt-2 text-white">This course covers the basic concepts and tools for building static and dynamic websites. Students will learn HTML, CSS, JavaScript, and jQuery to create engaging and interactive web pages.</p>
                      </div>
                    </div>
                  </>
                );
