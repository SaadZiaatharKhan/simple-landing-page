                  ...
                  <>
                    <div className="w-[300px] bg-box-bg bg-opacity-80 rounded-md overflow-hidden">
                      <div className="relative">
                        <img src="https://codehelp-apis.vercel.app/get-top-courses/Business/Introduction%20To%20Marketing.png" alt="Introduction to Marketing" />
                      ...
                      <div className="p-4">
                        <p className="text-white font-semibolt text-lg leading-6">Introduction to Marketing</p>
                        <p className="mt-2 text-white">This course provides an overview of marketing principles and practices, including market research, segmentation, targeting, and positioning. Students will learn how to create effective marketing plans and campaigns, using both traditional and digital marketing techniques.</p>
                      </div>
                    </div>
                  </>
                );
